<template>
  <div class="layout-container">
    <header class="app-header merged-header">
      <div class="menu-area">
        <el-menu :default-active="activeMenu" mode="horizontal" router class="admin-top-menu">
          <el-menu-item index="/admin/dashboard">首页</el-menu-item>
          <el-menu-item index="/admin/users">用户管理</el-menu-item>
          <el-menu-item index="/admin/export">导出与备份</el-menu-item>
        </el-menu>
      </div>
...
.admin-top-menu :deep(.el-menu-item) {
  height: 68px;
  line-height: 68px;
  padding: 0 18px;
...
.admin-top-menu :deep(.el-menu-item:hover) {
  color: var(--text-primary);
  background: rgba(234, 241, 251, 0.5);
}

.admin-top-menu :deep(.el-menu-item.is-active) {
