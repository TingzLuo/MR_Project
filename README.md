...
一个基于前后端分离架构的机器阅读理解（Machine Reading）Web 应用系统，支持文档上传、SCG 结构化内容图生成、MR 机器阅读理解等功能。
...
| SCG 生成 | 基于文档内容生成结构化内容图（Structure Content Graph） |
| MR 阅读理解 | 基于文档进行机器阅读理解，生成问答结果 |
| 操作记录 | 查看历史操作活动 |
| 个人中心 | 修改个人信息、修改密码 |
